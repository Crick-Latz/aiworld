...
def main() -> int:
    ...
    parser.add_argument("--profile", choices=["legacy", "execution", "causal", "framework", "information", "material_request", "commitment", "holder_evidence", "holder_reachability"], default="framework")
